...
public class PlayerServiceImpl implements PlayerService {
    ...
    @Override
    public Long getCount(String name, String title, Race race, Profession profession, Long after, Long before, Boolean banned, Integer minExperience, Integer maxExperience, Integer minLevel, Integer maxLevel) {
        Long count = playerRepository.count((Root < Player > root, CriteriaQuery < ? > query, CriteriaBuilder cb) ->{
            List<Predicate> predicates = new ArrayList<>();
            if (name != null) {
                predicates.add(cb.like(root.get("name").as(String.class), "%" + name + "%"));
            }
